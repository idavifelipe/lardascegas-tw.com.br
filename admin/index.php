...
ob_start();
session_start();
if(isset($_SESSION['usuarioldc']) && (isset($_SESSION['senhaldc']))){
...
<head>
    <meta charset="utf-8">
    <title>Login - Sistema de postagem v.1</title>
...
if(isset($_POST['logar'])){
		...
		try{
			...
			if($contar>0){
				...
				$senha	 = $_POST['senha'];
				$_SESSION['usuarioldc'] = $usuario;
				$_SESSION['senhaldc'] = $senha;
