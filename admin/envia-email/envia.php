<?php  
		...
		$mensagem = utf8_decode (strip_tags(trim($_POST['mensagem'])));
			...
			$Email->Port = 'portapadrao'; // Porta de envio
			...
			$Email->From = 'contato@lardascegas.com.br';
			// nome do remetente do email
			$Email->FromName = utf8_decode($email);
			// Endereço de destino do emaail, ou seja, pra onde você quer que a mensagem do formulário vá?
			$Email->AddReplyTo($email, $nome);
			$Email->AddAddress("contato@lardascegas.com.br"); // para quem será enviada a mensagem
			// informando no email, o assunto da mensagem
			$Email->Subject = "(seudominio.com.br)";
